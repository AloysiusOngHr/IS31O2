...
<form id="form" method="post" action="CreateSupplierList">
<table width="480" border="0">
  <tr>
    <th scope="col">Description:</th>
    <td style="font-weight:bolder"><input type="text" name="name" id="name"  style="width: 234px"/></td>
  </tr>
   <tr>
    <th scope="col">Length (ft):</th>
    <td style="font-weight:bolder"><input type="text" name="len" id="len" ></input></td>
  </tr>
   <tr>
    <th width="158" scope="col"> Breath (ft):</th>
    <td width="397">
      <label>
        <input name="breath" id ="breath"/>      
      </label>  
    </td>
  </tr>
     <tr>
    <th width="158" scope="col"> Height (ft):</th>
    <td width="397">
      <label>
   ...
   <tr>
    <th width="158" scope="col"> Weight (KG):</th>
    <td width="397">
      <label>
