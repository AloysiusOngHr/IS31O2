...
<form id="form" method="post" action="CreateInventory">
<table width="480" border="0">
  <tr>
    <th scope="col">Internal Reference:</th>
    <td style="font-weight:bolder"><input type="text" name="iR" id="iR"  style="width: 234px"/></td>
  </tr>
  <tr>
   ...
   <tr>
    ...
    <td width="397">
     ...
     <tr>
    <th width="158" scope="col"> Rent Price:</th>
    <td width="397">
      <label>
        <input name="rentPrice" id ="rentPrice"/>      
      </label>  
      
    </td>
  </tr>
   <tr>
    <th width="158" scope="col"> Unit:</th>
    <td width="397">
      <label>
