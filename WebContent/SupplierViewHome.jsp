...
<div class="art-post-inner art-article">
 ...
 <table width="396" border="4">
   <tr>
     <th width="48" scope="col" id="underline" style="width: 101px"><strong>Supplier Id</strong></th>
     <th width="48" scope="col" id="underline" style="width: 101px"><strong>Company Name</strong></th>
     <th width="48" scope="col" id="underline" style="width: 101px"><strong>Address</strong></th>
     <th width="48" scope="col" id="underline" style="width: 101px"><strong>Postal Code</strong></th>
     <th width="48" scope="col" id="underline" style="width: 101px"><strong>Country</strong></th>
     <th width="48" scope="col" id="underline" style="width: 101px"><strong>Contact Person</strong></th>
     <th width="48" scope="col" id="underline" style="width: 101px"><strong>Contact No</strong></th>
     <th width="48" scope="col" id="underline" style="width: 101px"><strong>Select</strong></th>
   </tr>
   <%for(int i = 0; i < data.size();i++){ 
   	 supplierGetSet sup = (supplierGetSet) data.get(i);
   	 String sid = Integer.toString(sup.getSupplierId());
   %>
  <tr>
     <td><jsp:expression> sup.getSupplierId() </jsp:expression></td>
     <td><jsp:expression> sup.getCompanyName() </jsp:expression></td>
     <td><jsp:expression> sup.getAddress() </jsp:expression></td>
     <td><jsp:expression> sup.getPoCode() </jsp:expression></td>
	 <td><jsp:expression> sup.getCountry() </jsp:expression></td>
     <td><jsp:expression> sup.getContactPerson() </jsp:expression></td>
     <td><jsp:expression> sup.getContactNo() </jsp:expression></td>
     <td><input type="radio" name="search" value ="<%=sid%>"></td>
   </tr>
   <%}%>
 </table>
 <br><input type="submit" value="View Supplier's Sales Item"/></br>
 </form>
 <%}else{ %>
 ...
 <%} %>
<br></br>
 <input type="button" onclick="location.href='./CreateSupplier.jsp';" value="Create New Supplier!" />
