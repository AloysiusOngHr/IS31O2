...
<form id="form" method="post" action="CreateLocation">
<table width="480" border="0">
  <tr>
    <th scope="col">Location Name:</th>
    <td style="font-weight:bolder"><input type="text" name="lN" id="lN"  style="width: 234px"/></td>
  </tr>
  <tr>
    <th scope="col">Description:</th>
    <td style="font-weight:bolder"><input type="text" name="desc" id="desc"  style="width: 234px"/></td>
  </tr>
<tr>
