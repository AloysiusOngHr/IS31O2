...
<div class="art-vmenublock">
	...
	<li>
		<a href="./LocationHome.jsp"class="active"><span class="l"></span><span class="r"></span><span class="t">Location</span></a>
	</li>	
	<li>
...
<p id=underline style=font-size:15px><strong>Search Location using location name:</strong></p>
 
<form action="searchLocation" method="post">
 		<p><input name="sLoc" type="text" id="sLoc" size="43"/>
	      </label>
 ...
 <table width="396" border="4">
   <tr>
     <th width="48" scope="col" id="underline" style="width: 101px"><strong>Location Id</strong></th>
     <th width="48" scope="col" id="underline" style="width: 101px"><strong>Location Name</strong></th>
     <th width="48" scope="col" id="underline" style="width: 101px"><strong>Description</strong></th>
   </tr>
   <%for(int i = 0; i < data.size();i++){ 
	   locationGetSet loc = (locationGetSet) data.get(i);
   %>
  <tr>
     <td><jsp:expression> loc.getLocationId() </jsp:expression></td>
     <td><jsp:expression> loc.getLocationName() </jsp:expression></td>
     <td><jsp:expression> loc.getDescription() </jsp:expression></td>
 ...
 <%} %>
<br></br>
 <input type="button" onclick="location.href='./CreateLocation.jsp';" value="Create New Location!" />
